(() => {
  ...
  const translations = {
    ...
    "Selected concept": "Concepto elegido",
    "Archived concepts": "Conceptos archivados",
    "Selected direction": "Direccion elegida",
    "Concept 4 is the working base.": "El Concepto 4 es la base de trabajo.",
    "Quiet Foundation is now the preferred V1 direction: calm, institutional, transparent, and centered on the formal Málaga association identity. The other concepts are archived below for reference.": "Base Serena es ahora la direccion preferida para V1: serena, institucional, transparente y centrada en la identidad formal de la asociacion en Malaga. Los otros conceptos quedan archivados abajo como referencia.",
    ...
    "Concept hub": "Panel de conceptos",
    "Archive: 1": "Archivo: 1",
    "Archive: 2": "Archivo: 2",
    "Archive: 3": "Archivo: 3",
    "Archive: 5": "Archivo: 5",
