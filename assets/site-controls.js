(() => {
  ...
  const translations = {
    es: {
      ...
      "Current program images are selected Diez42 photos pending final web-use and consent confirmation. Site copy is V1 draft content and should be confirmed before final launch.": "Las imagenes actuales de programas son fotos seleccionadas de Diez42 pendientes de confirmacion final de uso web y consentimiento. El texto del sitio es contenido V1 y debe confirmarse antes del lanzamiento final.",
    ...
    "pt-BR": {
      ...
      "Current program images are selected Diez42 photos pending final web-use and consent confirmation. Site copy is V1 draft content and should be confirmed before final launch.": "As imagens atuais dos programas são fotos selecionadas da Diez42 pendentes de confirmação final de uso na web e consentimento. O texto do site é conteúdo preliminar da V1 e deve ser confirmado antes do lançamento final.",
