...
The site now has compact top-right controls: a language selector, a sun/moon day-night toggle, and a subtle visible version pill. Preferences are saved in `localStorage` so the selected language and theme persist on the homepage.
...
- Versioning follows the PhotosByElie-style date-based SOP: `83` is days since `2026-02-28`; `.1` is the second user-visible build for the day.
- Repo: `https://github.com/ec92009/Diez-42`.
- Local preview: `http://localhost:8042/?v=83.1`.
- Main files:
